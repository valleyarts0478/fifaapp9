                    ...
                    <form method="post" action="{{ route('team_owner.players.update', ['player' => $player->id]) }}">
                        ...
                        <div class="container px-5 mx-auto flex">
                            <div
                                ...
                                <h2 class="text-gray-900 text-lg mb-1 font-nomal title-font">選手登録</h2>
                                <p class="leading-relaxed mb-1 text-gray-600">登録説明</p>
                                <p class="text-sm ">ポジションと背番号のみ変更が可能です。選手名を間違えて登録してしまった場合、退団する選手はディスコード上で運営にご連絡ください。</p>
                                    <label for="convention_id" class="mt-4 leading-7 text-sm text-gray-600">大会名</label>
                                    {{-- <select name="convention_id" id="convention_id"
                                        class="w-full mb-4 bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out"> --}}
                                    ...
                                    <label for="team_owner_id" class="mt-4 leading-7 text-sm text-gray-600">チーム名</label>
                                    {{-- <select name="team_owner_id" id="team_owner_id"
                                    ...
                                    <div class="mt-4 relative mb-4">
                                        <label for="player_name"
                                            class="leading-7 text-sm text-gray-600">選手名</label>
                                    ...
                                    <div class="p-2 flex justify-around w-full mt-4">
                                        <button type="button"
                                            onclick="location.href='{{ route('team_owner.players.index') }}'"
                                            class="text-gray bg-gray-200 border-0 py-2 px-8 focus:outline-none hover:bg-gray-400 rounded text-lg">戻る</button>
                                        <button type="submit"
                                            class="text-white bg-ral-400 border-0 py-2 px-8 focus:outline-none hover:bg-indigo-600 rounded text-lg">更新</button>
                                    </div>
                            </div>
                    </form>
                </div>
