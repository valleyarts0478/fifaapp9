                      ...
                      <div class="lg:w-1/3 md:w-1/2 bg-white rounded-lg p-8 flex flex-col md:mx-auto w-full mt-10 md:mt-0 relative z-10 shadow-md">
                        ...
                        <div class="relative mb-4">
                          ...
                          @if ($team_owner->team_name === $gameResult->game->home_team)
                            <input type="number" pattern="\d*" id="goal" name="total_goal" value="{{$gameResult->home_goal}}" class="w-16 bg-white rounded border border-gray-300 focus:border-indigo-500 focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">
                          @elseif ($team_owner->team_name === $gameResult->game->away_team)
                            <input type="number" pattern="\d*" id="goal" name="total_goal" value="{{$gameResult->away_goal}}" class="w-16 bg-white rounded border border-gray-300 focus:border-indigo-500 focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">
                          @else 
                        ...
                        @if ($team_owner->team_name === $gameResult->game->home_team)
                        <input type="number" pattern="\d*" id="own_goal" name="own_goal" value="{{$gameResult->home_own_goal}}" class="w-16 mt-2 bg-white rounded border border-gray-300 focus:border-indigo-500 focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">
                        @elseif ($team_owner->team_name === $gameResult->game->away_team)
                        <input type="number" pattern="\d*" id="own_goal" name="own_goal" value="{{$gameResult->away_own_goal}}" class="w-16 mt-2 bg-white rounded border border-gray-300 focus:border-indigo-500 focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">
                        @endif
                        </div>
                        <!--ゴール・アシスト部分ここから -->
                             <div class="relative mb-4">
