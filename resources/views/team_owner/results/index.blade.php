        ...
        <div class="container px-2 py-12 mx-auto">
          ...
          <x-flash-message status="session('status')" />
            <div class="container px-2 py-8 mx-auto">
              ...
              <div class="static">
                <button onclick="location.href='{{ route('team_owner.results.edit', ['result' => $result->id ]) }}'" class="relative top-4 right-0 bg-gray-300 text-xs text-gray-600 rounded-full h-8 w-8">入力</button>      
               </div>
              @if(($result->home_goal) === null && ($result->away_goal) === null)
