      ...
      <section class="text-gray-600 body-font">
        <div class="container px-4 py-24 mx-auto">
          <div class="flex flex-wrap -m-4">
            ...
            <div class="p-4 md:w-1/3">
              <div class="rounded-lg overflow-hidden">
                  <a href="/team_rank"><img class="lg:h-48 md:h-36 w-full object-cover object-center" src="{{asset('storage/top/' . "team_ranking_bn.jpg")}}" alt="team_list"></a>
              </div>
            </div>
            <div class="p-4 md:w-1/3">
              <div class="rounded-lg overflow-hidden">
                  <a href="/player_rank"><img class="lg:h-48 md:h-36 w-full object-cover object-center" src="{{asset('storage/top/' . "team_player_rank_bn.jpg")}}" alt="team_list"></a>
              </div>
            </div>
